...
export default function ResultVideo({ filename, transcriptionItems }) {
  const videoUrl = 'https://athul-epic-captions.s3.amazonaws.com/' + filename;
  ...
  return (
    <>
      <div className="mb-4">
        <button
          onClick={transcode}
          className="bg-[#6233ab] py-2 px-6 rounded-full inline-flex gap-2 border-2 border-purple-700/50 cursor-pointer"
        >
          <SparklesIcon />
